...
class SuspiciousIPMiddleware(object): # pragma: no cover
    ...
    def process_request(self, request):
        ...
        logger.info('process_request: : ' + request.is_tor_exit_node)
        ...
        logger.info('check_open_proxy: : ' + request.is_open_proxy)
        request.is_open_proxy = check_open_proxy

        def check_suspicious():
            logger.info('check_suspicious: : ')
